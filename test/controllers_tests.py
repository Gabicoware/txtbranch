...
class StoryControllerUnauthenticatedTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.testbed.setup_env(USER_EMAIL=None,USER_ID=None, USER_IS_ADMIN=None)
        self.testbed.init_user_stub()
...
class PageControllerUnauthenticatedTestCase(unittest.TestCase):
